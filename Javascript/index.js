...
let productsListUrl = 'https://my-json-server.typicode.com/KailashRajkumar/Swag-Of-India/db';
let productsList;
let htmlToReturn = "",
  htmlToReturn2 = "",
  reviews = "",
...
async function showProducts(Url) {
  fetch('https://my-json-server.typicode.com/KailashRajkumar/Swag-Of-India/db')
